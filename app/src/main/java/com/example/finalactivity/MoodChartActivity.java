...
public class MoodChartActivity<Mood> extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listMood.setAdapter(new MyCustomAdapter(MoodChartActivity.this, moodsList));
    }
    ...
    public class MyCustomAdapter extends ArrayAdapter {
        ...
        MyCustomAdapter(Context context, ArrayList<Mood> moodsList) {
            super(context, R.layout.activity_custom_layout, moodsList);
        ...
        public View getView(int position, View convertView, @NonNull ViewGroup parent) {
            ...
            if (view == null) {
                ...
                if (inflater != null) {
                    view = inflater.inflate(R.layout.activity_custom_layout, null);
                }
            }
            ...
            if (moodColor != 5) {
                moodTextView.setBackgroundColor(ContextCompat.getColor(MoodChartActivity.this, moodColor));
            } else {
            ...
            moodImageButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Toast.makeText(MoodChartActivity.this, moodMessage, Toast.LENGTH_LONG).show();
                }
            });
